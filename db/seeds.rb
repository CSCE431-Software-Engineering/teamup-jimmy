...
# Seed Gyms
gym1 = Gym.create(name: 'Polo Gym', address: '322 Polo Rd, College Station, TX 77843', start_time: '06:00',
                  end_time: '21:00')
gym2 = Gym.create(name: 'Student Rec Center', address: '187 Corrington Dr, College Station, TX 77843',
...
# Seed Activity Logs
activity_log1 = ActivityLog.create(activity_id: activity1.id, gym_id: gym1.id, description: 'Morning Yoga Session',
                                   hours: 1.5, date: Date.today)
activity_log2 = ActivityLog.create(activity_id: activity2.id, gym_id: gym2.id, description: 'Evening Weights',
                                   hours: 2.0, date: Date.today)
